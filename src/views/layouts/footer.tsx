			...
			<div className="container pb-1 pb-lg-5">
				<div className="row content-space-t-2">
						...
						<ul className="list-unstyled list-py-1">
							<li>
								<a className="link-sm link-light" href="/">
									<i className="bi-geo-alt-fill me-1"></i> 153
									Williamson Plaza, Maggieberg
								</a>
							</li>
							<li>
								<a
								...
								>
									<i className="bi-telephone-inbound-fill me-1"></i>{' '}
									+1 (062) 109-9222
								</a>
							</li>
						</ul>
					...
					<div className="col-sm">
						...
						<ul className="list-unstyled list-py-1 mb-5">
							<li>
								<a className="link-sm link-light" href="/">
									<i className="bi-question-circle-fill me-1"></i>{' '}
									Help
								</a>
							</li>
							<li>
				...
				<div className="w-md-85 text-lg-center mx-lg-auto">
					...
					<p className="text-white-50 small">
						...
						cookies for storing information to help provide you with
						a better, faster and safer experience and for marketing
						purposes.
					</p>
				</div>
				{/* <!-- End Copyright --> */}
